...
datesAndEmails.sh scripts/sample/emails.txt 2020-07-09 2020-07-20 > $log

echo "philip.rice@ing.com,2020-07-09
phil.rice@iee.org,2020-07-09
...
phil.rice@validoc.org,2020-07-11
...
phil.rice@validoc.org,2020-07-19
philip.rice@ing.com,2020-07-20
phil.rice@iee.org,2020-07-20
phil.rice@validoc.org,2020-07-20"  | diff -w - $log
